 ...
 * Series Data
 */
function generateData2(count: number, yrange: { max: number; min: number; }) {
  var i = 0;
  var series = [];
  while (i < count) {
...
const candlestickChart: ChartType = {
  series: [
    {
      name: 'candle',
      data: [
...
const basictimelinechart: ChartType = {
  series: [
    {
      data: [
        {
...
const multipleradarchart: ChartType = {
  series: [
    {
      name: 'Series Blue',
      data: [80, 50, 30, 40, 100, 20],
 ...
 * Basic Scatter Chart
 */
const basicScatterChart: ChartType = {
  series: [{
    name: "SAMPLE A",
    data: [
 ...
 * Basic Heatmap Chart
 */
const basicHeatmapChart: ChartType = {
  series: [{
    name: 'Metric1',
 ...
 * Basic Treemap Chart
 */
const basicTreemapChart: ChartType = {
  series: [
    {
      data: [
        {
